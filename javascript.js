...
//Below, we call in Mapbox tiles and use the options to set the max zoom to 18, 
//include our attribution, 
//specify that the tiles set we want is mapbox.streets, 
//and provide the access token for Mapbox's API
